    ...
    render() {
        return (
            <div>
                ...
                <Button type="submit" className="fa fa-pencil fa-lg" outline onClick={this.toggleModal}>
                    Submit Comment
                </Button>
                    ...
                    <ModalBody>
                        <LocalForm onSubmit={values => this.handleSubmit(values)}>
                            ...
                            <div className="form-group">
                                <Label htmlFor="rating" id="rating" name="rating">Rating</Label>
                            ...
                            <div className="form-group">
                                <Label htmlFor="author" id="author" name="author">Name</Label>
                            ...
                            <div className="form-group">
                                <Label htmlFor="text" id="text" name="text" >Comment</Label>
